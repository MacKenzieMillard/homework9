var MODEL = (function(){
  ...
  `;
    ...
    <h1>Hey Michael, create your recipe!</h1>
    ...
    <div class="createRecipeBtn">
      <button>Create Recipe</button>
    </div>
  </div>
  `;
    var yourRecipesContent = `<div class="yourRecipes">
    <h1>Hey Michael, here are your recipes!</h1>
    <div class="gallery">
      <div class="recipe">
        <div class="pizza">
          <div class="pizzaImg">
  ...
  // i don't think i ever figured out how to include other links into the 'one page' thing when its not in the nav (i.e. clicking a link from yourRecipesContent and then somehow getting to the recipeDetails part), so im just gonna have to make it not one page :/ sorry
